...
var evaluateAsrCmd = &cobra.Command{
	...
	Long: fmt.Sprintf(`Evaluates ASR accuracy for the given model. To run ASR evaluation, you need a
set of ground truth transcripts. Use the %s command to get started.
